...
We are curious to see how severity is impacted by conditions present at the time of the accident. One of our goals for this project is to be able to classify the severity of an accident using temperature and wind speed as predictors. We can't see any definitive groups of observations by level of severity, but we will attempt to classify these accidents with minimal error.  
