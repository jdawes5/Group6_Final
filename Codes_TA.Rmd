...
df<-na.omit(df)
df$Severity[df$Severity == '1'] <- 'Not Severe'
df$Severity[df$Severity == '2'] <- 'Kind of Severe'
df$Severity[df$Severity == '3'] <- 'Severe'
df$Severity[df$Severity == '4'] <- 'Very Severe'
...
When there was an amenity, the odds of the accident being more severe (i.e.,very severe, kind of severe and very severe versus not severe) was 1.084 times that of the accidents which had no amenity, holding constant all other variables.

When there was a crossing, the odds of the accident being more severe (i.e.,very severe, kind of severe and very severe versus not severe) was 1.224 times that of the accidents which had no crossing, holding constant all other variables.

When there was a junction, the odds of the accident being more severe (i.e.,very severe, kind of severe and very severe versus not severe) was 2.767 times that of the accidents which had no junction, holding constant all other variables.


When there was traffic-signal, the odds of the accident being more severe (i.e.,very severe, kind of severe and very severe versus not severe) was 2.061 times that of the accidents which had no traffic-signal, holding constant all other variables.
