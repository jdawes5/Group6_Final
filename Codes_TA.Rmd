...
loadPkg("ggplot2")
ggplot(dataset, aes(x=civ.light)) +
...
ggplot(dataset, aes(x=vis, y=civ.light)) +
  geom_point(size=2, shape=23)


ggplot(dataset, aes(y=vis, x=civ.light, fill=factor(civ.light))) +
...
ggplot(data = dataset, aes(vis)) + geom_histogram()
```
